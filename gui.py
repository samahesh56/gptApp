...
class Main(tk.Frame):
    ...
    def on_send_button_click(self):
        ...
        gpt_response = self.conversational_logic.chat_gpt(user_input, model=self.conversational_logic.model, max_tokens=self.conversational_logic.max_tokens) #calls GPT model, returns response. Change model here.
